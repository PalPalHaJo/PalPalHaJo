...
public class BtnEvents : MonoBehaviour
{
    ...
    public void EventInit()
    {
        ...
        stage1.onClick.AddListener(() => stageManager.StartStage());
        stage2.onClick.AddListener(() => stageManager.StartStage());
        stage3.onClick.AddListener(() => stageManager.StartStage());
        stage4.onClick.AddListener(() => stageManager.StartStage());
    }
