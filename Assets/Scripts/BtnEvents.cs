...
public class BtnEvents : MonoBehaviour
{
    ...
    public void EventInit()
    {
        ...
        stage1.onClick.AddListener(() => SystemManager.ui.TransitionScene(1));
        stage2.onClick.AddListener(() => SystemManager.ui.TransitionScene(2));
        stage3.onClick.AddListener(() => SystemManager.ui.TransitionScene(3));
        stage4.onClick.AddListener(() => SystemManager.ui.TransitionScene(4));
    }
